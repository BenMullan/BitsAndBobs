...
- [xhtml-1920x1080-webcam-viewer](https://raw.githubusercontent.com/BenMullan/BitsAndBobs/refs/heads/main/MiscSource/simple-webcam-viewer-1920-1080.xhtml)
...
A collection of useful programming, maths, art, and file-system tools! See [MNUtils Index](https://github.com/BenMullan/BitsAndBobs/blob/main/Utilities!/_Index.txt).<br/>
Download [here](https://github.com/BenMullan/BitsAndBobs/releases/download/MNUtils/BM-MullNet-Utilities-Dec-2024.zip) (v2024).
...
| ConsoleInfo.exe        	| [CLI] Displays configuration information for the current Win32 Console                  	|
...
| mvsys.exe             	| [GUI] Like Windows' "mmsys.cpl" tool, but for video-devices; 📷 dialogs + previews.   	|
...
| RubiksCube.exe         	| Visualiser for a 6-face Rubik's Cube. Supports cube serialization.                     	|
| RunHidden.exe          	| [CLI] Creates a process without a GUI. See [Details] tab in explorer Properties.        	|
...
| SQLMaster.exe          	| Tiny version of SQL Server Management Studio!                                           	|
...
| WebGet.exe             	| [CLI] Simple alternative to cURL. E.g. WebGet http://theoldnet.com/                   	|
...
| bdm.cmd                	| [CLI] Batch-file version of Doorman.exe; doesn't impede non-linebreak-terminated stdout	|
...
### Misc
- [mini-music](https://drive.google.com/file/d/1TCK79vc2Gq8g_mtpjlPskzLMOgBOr95n/view)
- [the-pin--and--tmws](https://drive.google.com/drive/folders/1Ep52TAw9XhBPCxLhln62V1RAPJhKdv4w)
